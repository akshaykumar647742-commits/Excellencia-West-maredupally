...
import { X, Download, ExternalLink, FileText, Sparkles, MessageCircleQuestion } from 'lucide-react';

export default function ViewMaterialModal({ material, onClose, onAskDoubt }) {
